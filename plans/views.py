...
from secret import key, monthly, yearly
...
def checkout(request):
    ...
    coupons = {"blackfriday": 31, "welcome": 10}
    ...
    if request.method == "POST":
        ...
        if request.method == "GET" and "coupon" in request.GET:
            ...
            if request.GET["coupon"].lower() in coupons:
                ...
                coupon_shilling = str(coupon_price)[:-2] + "." + str(coupon_price)[-2:]
                final_shilling = str(price)[:-2] + "." + str(price)[-2:]
        ...
        return render(
            ...
            "plans/checkout.html",
            {
                ...
                "coupon": coupon,
                "price": price,
                "og_shilling": og_shilling,
                "coupon_shilling": coupon_shilling,
                "final_shilling": final_shilling,
            },
        )
